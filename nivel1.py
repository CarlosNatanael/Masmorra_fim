...
def nivel_um(player):
    ...
    time.sleep(2)
    print("(O mago sorri, lento, como um gato diante de um rato.)")
    time.sleep(3)
    ...
    time.sleep(1)
    input("\nPressione enter para continuar")
    print("🧙Eldramar: 'Antes de seguir adiante, responda ao seguinte enigma. Caso falhe, as criaturas da sombras virão cobrar o preço...'\n")
    time.sleep(1)
    print("\n(E antes que Carlos possa responder, Eldramar se dissolve nas sombras, deixando apenas um riso ecoando nas paredes de pedra.)\n")
    ...
    if "respiração" in resposta or "fôlego" in resposta:
        ...
        inimigos = [
            {"nome": "Sombra Goblin nv:1", "vida": 30, "força": 30, "defesa": 25},
            {"nome": "Sombra Goblin nv:2", "vida": 35, "força": 40, "defesa": 30}
        ]
