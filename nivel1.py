...
def nivel_um(player):
    ...
    time.sleep(5)
    print(f"\nVelthurion: Saudações, {player['nome']}. Eu sou Velthurion, o guardião do véu entre os mundos.")
    print("Velthurion: Você foi trazido a Aldurian por forças que nem mesmo eu compreendo por completo.")
    time.sleep(5)
    while True:
        ...
        if escolha == "1":
            print("\nVelthurion: Aldurian é um mundo fragmentado entre luz e trevas. Você terá um papel crucial aqui.")
        elif escolha == "2":
            print("\nVocê se levanta. As paredes do templo estão cobertas de inscrições antigas.")
        elif escolha == "3":
            print("\nVocê apenas observa em silêncio. Velthurion entende sua hesitação.\n")
            time.sleep(5)
            print(f"Velthurion: Entendo o seu silêncio {player['nome']}, mas quero saber mais sobre sua personalidade\n")
            time.sleep(5)
            print("(Em instantes Velthurion estala os dedos e me leva um mercado aonde encontro tal situação)")
            ...
            if escolha1 == "1":
                ...
                time.sleep(5)
            print(f"\nVelthurion: Interessante... Vejo que você é {player['personalidade']}.\n")
            break
        else:
            print("Escolha inválida. Tente novamente.")

    print("\nVocê se pergunta em como Velthurion sabe o seu nome.\n")
    time.sleep(5)
    print(f"{player['nome']}: Como você sabe meu nome?")
    time.sleep(5)
    print("\n(O mago sorri, lento, como um gato diante de um rato.)\n")
    time.sleep(5)
    print("Velthurion: Você acha que foi um acidente? Que caiu aqui por... sorte?")
    time.sleep(5)
    print("\n(Ele dá um passo à frente, e as sombras ao seu redor parecem se esticar.)\n")
    time.sleep(5)
    print("Velthurion: Nomes têm poder, jovem. E o seu... ecoou através do Véu.")
    time.sleep(5)
    print(f"{player['nome']}: Isso não explica nada. Quem é você? O que quer?")
    time.sleep(5)
    print("\n(Velthurion ergue uma mão enrugada, e um globo de névoa escura se forma entre seus dedos, mostrando flashes do passado: a biblioteca, o grimório, o portal.)\n")
    time.sleep(5)
    print("Velthurion: Sou o último dos Vigias Eternos. Acompanhei o nascimento deste mundo, e talvez seu fim.")
    time.sleep(5)
    print("Velthurion: (O globo se desfaz, e seu sorriso some.) Agora resta saber se você é forte o bastante para descobrir por quê.")
    time.sleep(5)
    ...
    time.sleep(5)
    print("Velthurion: É um fato. Mas não se preocupe... por enquanto. (Ele olha por cima do ombro, os olhos faiscando.) A masmorra fará pior.")
    time.sleep(5)
    input("\nPressione ENTER para continuar")
    print("\nVelthurion: 'Antes de seguir adiante, responda ao seguinte enigma. Caso falhe, as criaturas da sombras virão cobrar o preço...'\n")
    time.sleep(5)
    print(f"(E antes que {player['nome']} possa responder, Velthurion se dissolve nas sombras, deixando apenas um riso ecoando nas paredes de pedra.)\n")
    time.sleep(5)
