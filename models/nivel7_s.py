...
def nivel_7_sombra(player):
    ...
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: (voz trêmula, mas firme) Então este é o seu decreto... Que os ecos da luz o acompanhem até o fim, Monarca.")
    time.sleep(4)
    print("\n[bold yellow]Altherion[/bold yellow]: Eldramar... Ele não forjou esta masmorra. Não é seu criador. É apenas o servo que mantém a fornalha acesa.")
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: E você... (respiração falha) Você não é o herói desta história. Você é o braseiro... o centro do sacrifício.")
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: Cada passo que deu aqui alimentou o fogo. A masmorra não testa — ela consome. Ela molda os escolhidos em armas, ou os reduz a cinzas.")
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: Todos os que caminharam antes de ti tornaram-se parte da fundação... almas diluídas no Éter da Forja.")
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: Mas ouça... há uma rachadura na eternidade. A forja precisa de almas... mas não suporta o fulgor da luz verdadeira.")
    time.sleep(5)
    print("\n[bold yellow]Altherion[/bold yellow]: Destrua o núcleo... leve a luz onde ela jamais tocou... e talvez, só talvez, você verá Eldramar arder em sua própria mentira.")
    time.sleep(5)
    print("\nAltherion começa a desintegrar em fragmentos de cristal dourado, e sua voz enfraquece.")
    print("\n[bold yellow]Altherion[/bold yellow]: (últimas palavras) Corra, tolo... antes que o fogo perceba que você já vê através da fumaça.\n")
    time.sleep(5)
